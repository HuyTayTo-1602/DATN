...
class Company(Base):
    ...
    # Liên kết với tài khoản recruiter (1:N — một recruiter có thể sở hữu nhiều công ty)
    ...
    address = Column(String(500))                 # Địa chỉ trụ sở
    ...
    # Quan hệ ngược về User (back_populates phải khớp với User.companies)
